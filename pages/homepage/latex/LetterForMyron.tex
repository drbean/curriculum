...
\logo{/home/owuser/curriculum/pages/homepage/latex/160px-National_United_University_logo.svg.png} % Logo filename, your logo should have square dimensions (i.e. roughly the same width and height), if it does not, you will need to adjust spacing within the HEADER STRUCTURE block in structure.tex (read the comments carefully!)
...
\closing{Sincerely,\\
\includegraphics[width=2in,height=1.65cm]{/home/owuser/curriculum/pages/homepage/latex/signature.png} }
%----------------------------------------------------------------------------------------
%	OPTIONAL FOOTNOTE
%----------------------------------------------------------------------------------------
